...
(assert 
	(and 
		...
		(or (P <v2_y> <p1_subOrganizationOf> <p1_University1> <default_graph>) )
		(or (P <v2_x> <p1_email> <v2_z> <default_graph>) )
	)
)

; ------------ Conjecture ---------------------------
(assert (not (exists ((<v1_u> RDFValue)(<v1_x> RDFValue)(<v1_y> RDFValue)(<v1_z> RDFValue)) 
	(and 
		...
		(or (P <v1_y> <p1_subOrganizationOf> <v1_u> <default_graph>) )
