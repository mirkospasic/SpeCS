...
; ------------ Conjecture ---------------------------
(assert (not (exists ((<v1_c> RDFValue)(<v1_email> RDFValue)(<v1_name> RDFValue)(<v1_x> RDFValue)) 
	(and 
		...
		(or 
			(and 
				...
				(or (P <v1_c> <p1_shortName> <l_0> <default_graph>) )
			)
			(and 
				(or (P <v1_x> <p1_takesCourse> <v1_c> <default_graph>) )
				(or (P <v1_c> <p1_shortName> <l_1> <default_graph>) )
			)
			(and 
				(or (P <v1_x> <p1_takesCourse> <v1_c> <default_graph>) )
