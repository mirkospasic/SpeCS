...
; ------------ Conjecture ---------------------------
(assert (not (exists ((<v1_ag> RDFValue)(<v1_course> RDFValue)(<v1_dept> RDFValue)(<v1_email> RDFValue)(<v1_master> RDFValue)(<v1_s> RDFValue)(<v1_sx> RDFValue)(<v1_t> RDFValue)(<v1_x> RDFValue)(<v1_y> RDFValue)(<v1_z> RDFValue)) 
	(and 
		...
		(or (P <v1_x> <p1_masterDegreeFrom> <v1_master> <default_graph>) )
