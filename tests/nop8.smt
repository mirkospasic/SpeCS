...
(assert 
	(and 
		...
		(or (P <v2_x> <p1_takesCourse> <b2_b> <default_graph>) )
		(or (P <b2_b> <p1_shortName> <l_2> <default_graph>) )
	)
)

; ------------ Conjecture ---------------------------
(assert (not (exists ((<v1_c1> RDFValue)(<v1_c2> RDFValue)(<v1_x> RDFValue)) 
	(and 
