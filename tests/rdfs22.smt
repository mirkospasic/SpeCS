...
(declare-const	<p3_femaleHeadOf>	RDFValue)
(declare-const	<p3_maleHeadOf>	RDFValue)
...
(assert 
	(and 
		(or 
			(and 
				(or (P <v3_x> <p3_maleHeadOf> <v3_y> <default_graph>) )
			)
			(and 
				(or (P <v3_x> <p3_femaleHeadOf> <v3_y> <default_graph>) )
			)
		)
	)
)
